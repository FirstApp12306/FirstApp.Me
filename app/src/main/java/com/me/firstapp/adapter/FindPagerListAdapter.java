...
public class FindPagerListAdapter extends BaseAdapter {
    ...
    public FindPagerListAdapter(Context context, ArrayList<Note> notes, ArrayList<User> users, ArrayList<Topic> topics) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = View.inflate(context, R.layout.pager_find_list_item, null);
            holder.btnAddFriend = (ImageButton) convertView.findViewById(R.id.pager_find_list_item_btn_add_friend);
            holder.addedFriend = (TextView) convertView.findViewById(R.id.pager_find_list_item_added_friend);
            holder.btnPop = (ImageButton) convertView.findViewById(R.id.pager_find_list_item_pop);
            holder.ivAvatar = (CircleImageView) convertView.findViewById(R.id.pager_find_list_item_avatar);
            holder.tvTopicTitle = (TextView) convertView.findViewById(R.id.pager_find_list_item_topic_title);
            holder.tvUserName = (TextView) convertView.findViewById(R.id.pager_find_list_item_username);
            holder.ivNoteImage = (ImageView) convertView.findViewById(R.id.pager_find_list_item_note_image);
            holder.tvNoteContent = (TextView) convertView.findViewById(R.id.pager_find_list_item_content);
            holder.tvTime = (TextView) convertView.findViewById(R.id.pager_find_list_item_time);
            holder.btnComment = (Button) convertView.findViewById(R.id.pager_find_list_item_btn_comment);
            holder.btnAgree = (Button) convertView.findViewById(R.id.pager_find_list_item_btn_support);
        ...
        if (user.user_id.equals(loginUserID)){
            ...
            holder.addedFriend.setVisibility(View.INVISIBLE);
        }else{
        ...
        View.OnClickListener listener = new View.OnClickListener() {
            ...
            public void onClick(View v) {
                switch (v.getId()){
                    case R.id.pager_find_list_item_btn_add_friend :
                        if (loginFlag == true){
                        ...
                        break;
                    case R.id.pager_find_list_item_topic_title :
                        ...
                        break;
                    case R.id.pager_find_list_item_pop :
                        break;
                    case R.id.pager_find_list_item_avatar :
                        break;
                    case R.id.pager_find_list_item_note_image :
                        Intent intent2 = new Intent(context, ScanImageActivity.class);
                        intent2.putExtra("image_url", note.image_key);
                        context.startActivity(intent2);
                        break;
                    case R.id.pager_find_list_item_btn_comment :
                        ...
                        break;
                    case R.id.pager_find_list_item_btn_support :
                        if (agreeFlag == false ){
